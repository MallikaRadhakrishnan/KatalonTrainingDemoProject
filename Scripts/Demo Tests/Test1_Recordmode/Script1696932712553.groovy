...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_CURA Healthcare Service/input_Password_password'), 'g3/DOGG74jDua8tUcAmbsBSU6CJxFwda')
...
WebUI.setText(findTestObject('Page_CURA Healthcare Service/input_Demo account_form-control_1'), 'ThisIsNotAPassword')

WebUI.click(findTestObject('Page_CURA Healthcare Service/input_Demo account_form-control_1'))
...
WebUI.rightClick(findTestObject('Object Repository/Page_CURA Healthcare Service/td_14'))
